...
// OPENAP_JSON_CONVERT_FUNCS(ServiceSpecRollbackConfig, Parallelism, Delay, FailureAction, Monitor, MaxFailureRatio, Order)

void ServiceSpecRollbackConfig::ToJSON(Json & j) const
{
...
void ServiceSpecRollbackConfig::FromJSON(const Json & j)
{
