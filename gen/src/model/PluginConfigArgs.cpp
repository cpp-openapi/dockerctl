...
// OPENAP_JSON_CONVERT_FUNCS(PluginConfigArgs, Name, Description, Settable, Value)

void PluginConfigArgs::ToJSON(Json & j) const
{
...
void PluginConfigArgs::FromJSON(const Json & j)
{
